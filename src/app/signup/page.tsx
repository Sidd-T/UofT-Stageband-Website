...
const SignupPage = () => {
  ...
  //               {subtitle}
  //             </p>
  //             <p className="mb-20 pb-20 text-2xl font-semi-bold !leading-tight text-black dark:text-white sm:text-xl md:text-2xl">
  //               We are currently holding auditions for Stageband 2024-2025! They are scheduled on September 7th and 11th, from 6:00 pm to 8:00 pm.
  //               All instruments are welcome to try out, and there is an option for an online audition as well if the dates above don't work.
  //             </p>
  //             <div className="-mx-4 flex flex-wrap">
