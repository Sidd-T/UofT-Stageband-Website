      ...
      <div className="container">
        <div className="pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="flex w-full bg-lightgrey flex-col lg:flex-row"> {/* Use flex-col on small screens and flex-row on larger screens */}
              {/* Large image on top for smaller screens */}
              <div className="w-full lg:w-3/5 p-4">
                <div className="relative w-full aspect-[1024/683] mx-auto object-scale-down">
                  <Image
                ...
                <div className="grid grid-cols-4 gap-1">
                  {currentPageImages.map((image, index) => (
                    <div key={index} className="w-full">
                      ...
                      >
                        <div className={`${(index === selectedIndex) ? 'border-4 border-primary' : 'border'} relative block aspect-[4/3] w-full border-dark hover:border-4`}>
                          <Image
